...
Java_com_example_bulletopengles_TriangleRenderJNI_glesInit(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_bulletopengles_TriangleRenderJNI_glesRender(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_bulletopengles_TriangleRenderJNI_glesResize(JNIEnv *env, jobject thiz, jint width,
                                                             jint height) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_bulletopengles_TriangleRenderJNI_readShaderFile(JNIEnv *env, jobject thiz,
